...
namespace transport_router_proto {
PROTOBUF_CONSTEXPR RouterSettings::RouterSettings(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.bus_velocity_km_h_)*/0
...
const uint32_t TableStruct_transport_5frouter_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::transport_router_proto::RouterSettings, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::transport_router_proto::RouterSettings, _impl_.bus_velocity_km_h_),
  PROTOBUF_FIELD_OFFSET(::transport_router_proto::RouterSettings, _impl_.bus_wait_time_minutes_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::transport_router_proto::RouterSettings)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::transport_router_proto::_RouterSettings_default_instance_._instance,
};

const char descriptor_table_protodef_transport_5frouter_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\026transport_router.proto\022\026transport_rout"
  "er_proto\"J\n\016RouterSettings\022\031\n\021bus_veloci"
  "ty_km_h\030\001 \001(\005\022\035\n\025bus_wait_time_minutes\030\002"
  " \001(\005b\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_transport_5frouter_2eproto = {
    false, false, 132, descriptor_table_protodef_transport_5frouter_2eproto,
...
RouterSettings::RouterSettings(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:transport_router_proto.RouterSettings)
}
RouterSettings::RouterSettings(const RouterSettings& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  RouterSettings* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.bus_velocity_km_h_){}
    , decltype(_impl_.bus_wait_time_minutes_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.bus_velocity_km_h_, &from._impl_.bus_velocity_km_h_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.bus_wait_time_minutes_) -
    reinterpret_cast<char*>(&_impl_.bus_velocity_km_h_)) + sizeof(_impl_.bus_wait_time_minutes_));
  // @@protoc_insertion_point(copy_constructor:transport_router_proto.RouterSettings)
}
...
RouterSettings::~RouterSettings() {
  // @@protoc_insertion_point(destructor:transport_router_proto.RouterSettings)
...
// @@protoc_insertion_point(message_clear_start:transport_router_proto.RouterSettings)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;

  ::memset(&_impl_.bus_velocity_km_h_, 0, static_cast<size_t>(
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      // int32 bus_velocity_km_h = 1;
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          _impl_.bus_velocity_km_h_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      // int32 bus_wait_time_minutes = 2;
      case 2:
...
uint8_t* RouterSettings::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:transport_router_proto.RouterSettings)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  // int32 bus_velocity_km_h = 1;
  if (this->_internal_bus_velocity_km_h() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(1, this->_internal_bus_velocity_km_h(), target);
  }

  // int32 bus_wait_time_minutes = 2;
  if (this->_internal_bus_wait_time_minutes() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(2, this->_internal_bus_wait_time_minutes(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:transport_router_proto.RouterSettings)
  return target;
}

size_t RouterSettings::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:transport_router_proto.RouterSettings)
  size_t total_size = 0;
  ...
  // int32 bus_velocity_km_h = 1;
  if (this->_internal_bus_velocity_km_h() != 0) {
    total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(this->_internal_bus_velocity_km_h());
  }
...
void RouterSettings::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:transport_router_proto.RouterSettings)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  if (from._internal_bus_velocity_km_h() != 0) {
    _this->_internal_set_bus_velocity_km_h(from._internal_bus_velocity_km_h());
  }
...
// @@protoc_insertion_point(class_specific_copy_from_start:transport_router_proto.RouterSettings)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void RouterSettings::InternalSwap(RouterSettings* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(RouterSettings, _impl_.bus_wait_time_minutes_)
      + sizeof(RouterSettings::_impl_.bus_wait_time_minutes_)
      - PROTOBUF_FIELD_OFFSET(RouterSettings, _impl_.bus_velocity_km_h_)>(
          reinterpret_cast<char*>(&_impl_.bus_velocity_km_h_),
          reinterpret_cast<char*>(&other->_impl_.bus_velocity_km_h_));
}
...
template<> PROTOBUF_NOINLINE ::transport_router_proto::RouterSettings*
Arena::CreateMaybeMessage< ::transport_router_proto::RouterSettings >(Arena* arena) {
  return Arena::CreateMessageInternal< ::transport_router_proto::RouterSettings >(arena);
}
